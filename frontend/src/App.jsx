...
const PIE_COLORS = ["#0071E3", "#66A3FF", "#30D158", "#FF3B30", "#BF66FF", "#FFD60A"]; 
...
const css = `
  ...
  /* Theme variables for glassy look */
  :root{
    --bg: #0D1117;
    --card-bg: rgba(20,24,30,0.55);
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .topbar {
    background: linear-gradient(180deg,var(--card-bg), rgba(255,255,255,0.02)); border-bottom: 1px solid var(--border);
  ...
  .small-pie-card { padding: 8px; }
  .small-pie-card .card-body { padding: 8px 0 0 0; height: 120px; display:flex; align-items:center; justify-content:center; }
  ...
  .btn {
    ...
    cursor: pointer; border: none; transition: all 0.18s cubic-bezier(.2,.8,.2,1);
    font-family: 'DM Sans', sans-serif;
    position: relative; overflow: hidden;
  ...
  .form-control:focus { border-color: var(--accent); box-shadow: 0 6px 18px rgba(0,113,227,0.12); }
...
const themeCss = `
  ...
  .theme-light .form-control { background: rgba(255,255,255,0.9); color: #0D1117; border: 1px solid #E6EDF3; }
...
function DatePicker({ value, onChange, min }) {
  ...
  const TRANSLATIONS = {
    ...
    sw: {
      ...
      "form.enter_product_name": "Ingiza jina la spea",
      ...
      "form.product_name": "Jina la Spea",
      ...
      "confirm.delete_product": "Futa spea hii?",
      "alert.product_required": "Jina la spear na SKU vinahitajika",
    ...
    <div className="page">
      ...
      <div className="stats-grid">
        ...
        <div className="stat-card blue">
          ...
          <div className="card">
            ...
            <div className="card-body">
              <ResponsiveContainer width="100%" height={'100%'}>
                <PieChart>
                  <Pie data={catData} nameKey="name" cx="50%" cy="50%" innerRadius={"20%"} outerRadius={"80%"} paddingAngle={3} dataKey="value">
          ...
          <div className="card">
            <div className="card-header"><span className="card-title">{t(locale,'charts.sales_by_category')}</span></div>
            <div className="card-body">
              <ResponsiveContainer width="100%" height={'100%'}>
                <PieChart>
